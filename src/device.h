...
void device_data_input(struct m_usb_device *dev, unsigned char *buf, uint32_t length);

int device_add(struct m_usb_device *dev);
void device_remove(struct m_usb_device *dev);
